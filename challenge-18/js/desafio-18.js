(function(){
    ...
    */
    ...
    /*function formatarCPF( numCpf ){
        return numCpf.replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, function( regex, $1, $2, $3, $4 ){
            return arguments[1] + '.' + arguments[2] + '.' + arguments[3] + '-' + arguments[4];    
        });
    }

    function formatarCPF( numCpf ){
        return numCpf.replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, function( regex, arg1, arg2, arg3, arg4 ){
    ...
    cpfs.forEach(function( element ){
        console.log( formatarCPF( cleanCPF( element ) ) );
    });
    ...
    */
    ...
    var newFrase = 'Os meses de janeiro, junho e julho começam com a letra j';
    //console.log( newFrase.match(/ju(l|n)ho/g) );
    console.log( newFrase.match(/ju[ln]ho/g) );
    ...
    */
    ...
    console.log( tagsHtml.replace(/<(\w+)>([^<]+)<\/\w+>/g, '<$1>O texto dentro da tag "$1" é "$2"</$1>\n' ));
