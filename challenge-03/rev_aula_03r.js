...
pessoa.andar = function andar( qtdMetros ){
...
*/
console.log( pessoa.nomeCompleto() ); //Olá! Meu nome é Daniel Lima!
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
console.log( pessoa.mostrarAltura() ); //Minha altura é 1.83m.
...
*/
console.log( pessoa.caminhouQuantosMetros ); //5
