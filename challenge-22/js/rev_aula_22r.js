(function(){
    ...
    */
    function sum(){
        ...
        return Array.prototype.reduce.call( arguments, function( acumulado, valorAtual ){
    ...
    */
    ...
    function justNumbers( stringOriginal ){
        return stringOriginal.replace(/\D+/g, '' );
    }
    ...
    */
    ...
    console.log( sum.apply( this, numbers.split('') ) );
