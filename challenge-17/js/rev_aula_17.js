(function(){
    ...
    */
    ...
    console.log( text.replace( /Manuel Marques de Sousa/g, 'Daniel Lima' ) );
    ...
    */
    ...
    console.log( text.replace( /brasileiro/g, 'quixadaense' ) );
    ...
    */
    ...
    console.log( text.replace( /(O Centauro de Luvas)/, function( regex, value ){
    ...
    */
    ...
    console.log( getMonthNumber('março'), getMonthNumber('setembro'), getMonthNumber('dezembro') );
    ...
    */
    ...
    var regexDate = /(\d+) de (ju[nl]ho) de (\d+)/g;
    ...
    */
    ...
    function replaceDate(){
        return text.replace( regexDate, function( regex, dia, mes, ano ){
