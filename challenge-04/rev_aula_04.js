...
carro.addPessoas = function( qtdPessoas ){
    var newQtd = carro.quantidadePessoas + qtdPessoas;
    if( carro.quantidadePessoas >= carro.assentos && newQtd > carro.assentos ){
        return 'O carro já está lotado!';
    }
    if( newQtd > carro.assentos ){
        var vagas = carro.assentos - carro.quantidadePessoas;
        var vagasP = vagas === 1 ? 'pessoa' : 'pessoas';
        return 'Só cabem mais ' + vagas + ' ' + vagasP + '!'
    }
    carro.quantidadePessoas = newQtd;
