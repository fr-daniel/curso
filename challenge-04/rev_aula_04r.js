...
para o contrário.
*/
var isTruthy = function isTruthy( valor ){
    return !!valor;
};
...
carro.addPessoas = function addPessoas( qtdPessoas ){
    var pessoasNoCarro = carro.quantidadePessoas + qtdPessoas;
...
console.log( carro.obterMarcaModelo() ); //Esse carro é um Ford AX2017
