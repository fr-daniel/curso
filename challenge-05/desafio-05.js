...
var myArray = [ undefined, null, 3, true, 'Daniel' ];
...
console.log(selectIndice(newArray, 0));
console.log(selectIndice(newArray, 1));
console.log(selectIndice(newArray, 2));
console.log(selectIndice(newArray, 3));
console.log(selectIndice(newArray, 4));
